...
- **A-B Repeat** — Loop a specific segment by setting A and B points with the `A` key.
- **Chapters Support** — Navigate chapters from supported media files via the View menu.
